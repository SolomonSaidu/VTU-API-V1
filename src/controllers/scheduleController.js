...
const addAirtimeSchedule = async (req, res, next) => {
...
const addDataSchedule = async (req, res, next) => {
  const VALID_FREQUENCY = ["ONCE", "MINUTELY", "DAILY", "MONTHLY"];
...
export { getSchedule, addAirtimeSchedule, addDataSchedule, deleteScheduleById };
